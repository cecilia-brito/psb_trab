...
.org 0x002
    jmp INT0_ISR            ; interrupcao externa INT0

.org 0x001A
    jmp TIMER1_OVF_ISR      ; interrupcao de overflow do timer1
...
ler_adc:
    lds r20, ADCSRA
    ori r20, (1 << ADSC)              ; inicia conversao
    sts ADCSRA, r20

esperar_adc:
    lds r21, ADCSRA
    sbrs r21, 4                       ; espera flag ADIF
    rjmp esperar_adc
    lds r21, ADCSRA
    ori r21, (1 << ADIF)              ; limpa flag
    sts ADCSRA, r21
